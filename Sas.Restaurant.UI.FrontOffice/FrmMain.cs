...
using Sas.Restaurant.Core.Monitors;
...
namespace Sas.Restaurant.UI.FrontOffice
{
    public partial class FrmMain : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmMain()
        {
            ...
            controlKullaniciGiris1.KullaniciKontrolEvent += KullaniciGirisKButonu;


        }

        private void KullaniciGirisKButonu(object sender, KullaniciKontrolEventArgs e)
        {
            if (e.Kullanici==null)
            {
                MessageBox.Show("Girdiğiniz kullanıcı bilgisi hatalı");
            }
            else
            {
        ...
        private void UrunHareketChanged()
        {
            Invoke((MethodInvoker)delegate 
            {
                ...
                gridControlBildirim.DataSource = worker.AdisyonService.MutfakUrunHareketGetir(c=>c.SiparisDurum==SiparisDurum.ServiseHazir && DbFunctions.TruncateTime(c.EklenmeTarihi)==DateTime.Now);
            });
        }

        private void AramaKaydiChanged()
        {
            Invoke((MethodInvoker)delegate { AramaKaydiListele(); });
        }
        ...
        {
            FrmMusteriIslem form = new FrmMusteriIslem(new Entities.Tables.Musteri(), telefon);
            form.ShowDialog();
            if (form.Kaydedildi)
            {
                MusteriButtonOlusur();
        ...
        void GarsonButtonOlusur(PersonelTipi personelTipi)
        {
        ...
        private void MasaSec(object sender, EventArgs e)
        {
            ...
            GarsonButtonOlusur(PersonelTipi.Garson);
            navigationKategori.SelectedPage = pageKategoriUrunler;
        ...
        private void KategoriButonOlustur()
        {
        ...
        private void UrunClick(object sender, EventArgs e)
        {
            ...
            foreach (var porsiyon in button.Porsiyonlar)
            {
                ...
                flowPoriyon.Controls.Add(porsiyonButton);
            }
            if (button.Porsiyonlar.Count() == 1)
            {
                ControlPorsiyonButton buttonPorsiyon=(ControlPorsiyonButton) flowPoriyon.Controls[0];
        ...
        private void KeyPadSend(object sender, EventArgs e)
        {
            ...
            if (navigationKategori.SelectedPage==pageOdemeEkranı)
            {
        ...
        private void btnIndirim_Click(object sender, EventArgs e)
        {
            ...
            txtMiktar.Text = null;
            txtMiktar.Properties.NullValuePrompt = "Lütfen indirim oranını girin";
        }
        ...
        private void UrunHareketToplamlarGetir()
        {
        ...
        private void btnOdemeN_Click(object sender, EventArgs e)
        {
            keyPadIslem = KeypadIslem.Bol;
            txtMiktar.Text = null;
            txtMiktar.Properties.NullValuePrompt = "Lütfen blünecek oranı girin";
        }
        ...
        private void YeniSiparisEkle(Musteri musteri=null)
        {
            ...
            gridControl1.DataSource = worker.UrunHareketService.BindingList();
            gridControlOdeme.DataSource = worker.OdemeHareketService.BindingList();
            GarsonButtonOlusur(PersonelTipi.Kurye);
            navigationKategori.SelectedPage = pageKategoriUrunler;
            secilenAdisyon = new Adisyon();
            secilenAdisyon.Id = Guid.NewGuid();
        ...
        private void repoYeniKayitEkle_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Bu müşteri zaten kaydedilmiş.");
            }
        ...
        private void repoAdisyonOlustur_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (row.MusteriAdi == " ")
            {
                MessageBox.Show("Bu müşteri zaten kaydedilmemiş. Önceşikle kaydedin.");
            }
            else
            {
